...
export default function Maintenance(){
    ...
    const handleFormSubmit = (e) => {
        e.preventDefault();
        fetch('http://127.0.0.1:4000/api/maintenance/create', {
          method: 'POST',
          headers: {
          ...
          .then((data) => {
            console.log(data);
            setMaintenance((current) => [...current, data.data]);
    ...
    return (
        <div className="flex-1 ml-4 bg-gray-100">
            ...
            <Table columns={columns} entries={maintenance} people={maintenance}></Table>
        </div>
    )
}